...
async function main() {
  ...
  if(hre.hardhatArguments.network === "mumbai") { 
    ...
    deadline = 0; // conditional waterdrops have no deadline

    // Required condition info
    reqRecipient = deployer.address; // Test net requires stream to deployer
    reqToken = "0x42bb40bF79730451B11f6De1CbA222F17b87Afd7"; // fUSDCx
    ...
    deadline = 0; // No deadline used in this conditional drop
